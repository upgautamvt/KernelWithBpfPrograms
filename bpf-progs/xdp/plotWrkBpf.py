...
plt.title('Latency vs Iteration with BPF loaded')
plt.legend()
plt.grid(True)
...
plt.title('Transfer/sec vs Iteration with BPF loaded')
plt.legend()
plt.grid(True)

plt.tight_layout()
plt.savefig('combined_latency_throughput_bpf.png')  # Save plot to PNG
plt.close()
